...
def plot_genome_links(blast_file, metadata_file):
	...
	for seq in query_seqs:
		...
		# Add sequence name label near the start of the bar with 45-degree rotation
		ax.text(current_pos, label_y, seq, fontsize=8, verticalalignment='bottom', horizontalalignment='left', rotation=45)
	...
	for seq in subject_seqs:
		...
		# Add sequence name label near the start of the bar with 45-degree rotation
		ax.text(current_pos, y_offset - 0.1, seq, fontsize=8, verticalalignment='top', horizontalalignment='left', rotation=45)
