...
def plot_genome_links(blast_file, metadata_file):
	"""Create a plot showing links between two genomes with highlighted matched regions."""
	# Read input files
	...
	# Highlight matched regions and plot links
	for align in alignments:
		...
		if qseq in query_positions and sseq in subject_positions:
			...
			ax.plot(x, y, 'gray', alpha=0.3, linestyle='--')
